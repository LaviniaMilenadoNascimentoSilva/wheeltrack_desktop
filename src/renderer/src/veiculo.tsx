        ...
        {abaAtiva === 'lista' ? (
          ...
          <div className="form-card-v">
            ...
            <div className="form-grid-v">
              ...
              <div className="campo-v">
                <label>PLACA</label>
                <input type="text" placeholder="ABC-1D23" />
              </div>
              <div className="campo-v">
                <label>COR</label>
              ...
              <div className="campo-v">
                <label>CHASSI</label>
                <input type="text" placeholder="9BWZZZ..." />
              </div>
              <div className="campo-v">
                <label>RENAVAM</label>
