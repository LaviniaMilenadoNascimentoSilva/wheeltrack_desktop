    ...
    <div className="container-config">
      ...
      {aba === 'permissoes' && (
        <div className="card-aba">
          ...
          <div className="lista-checks">
            <label>
              <input type="checkbox" checked={permissaoVer} onChange={() => setPermissaoVer(!permissaoVer)} /> 
              Pode Visualizar o Sistema
            </label>
            <label>
              <input type="checkbox" checked={permissaoEditar} onChange={() => setPermissaoEditar(!permissaoEditar)} /> 
              Pode Editar Registros
            </label>
            <label>
              <input type="checkbox" checked={permissaoExcluir} onChange={() => setPermissaoExcluir(!permissaoExcluir)} /> 
              Pode Excluir Dados
            </label>
          </div>
        </div>
      ...
      {aba === 'etapas' && (
        <div className="card-aba">
          ...
          <button className="btn-add" onClick={adicionarEtapa}>+ Adicionar Nova Linha</button>
        </div>
      )}
