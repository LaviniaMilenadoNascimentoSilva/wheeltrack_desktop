      ...
      {abaAtiva === 'lista' ? (
        <>
          ...
          <div className="grid-etapas">
            <CardEtapa num="01" titulo="Recebimento e Vistoria" desc="Conferência do veículo e documentação" ativa />
            <CardEtapa num="02" titulo="Desmontagem" desc="Remoção de painéis e vidros" />
            <CardEtapa num="03" titulo="Instalação das Placas" desc="Posicionamento das placas balísticas" />
            <CardEtapa num="04" titulo="Vidros Blindados" desc="Aplicação de vidros laminados" destaque />
            <CardEtapa num="05" titulo="Montagem e Acabamento" desc="Reinstalação de componentes" />
            <CardEtapa num="06" titulo="Inspeção e Entrega" desc="Teste balístico e certificação" />
          </div>
          ...
          <div className="tabela-blindagem-box">
            <table className="tabela-blindagem">
              ...
              <tbody>
                <tr>
                  <td><strong>#BL-001</strong></td>
                  <td>Toyota Corolla · ABC-1D23</td>
                  <td>João P. Almeida</td>
                  <td><span className="etapa-tag v-03">03 — Placas</span></td>
                  <td>Carlos Souza</td>
                  <td>30/05/2026</td>
                  <td><span className="status-os andamento">Em Andamento</span></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="form-os-card">
          ...
          <div className="form-os-grid">
            <div className="campo-os"><label>CLIENTE</label><select><option>Selecionar...</option></select></div>
            <div className="campo-os"><label>VEÍCULO</label><select><option>Selecionar...</option></select></div>
            <div className="campo-os"><label>NÍVEL DE BLINDAGEM</label><select><option>Nível III — IIIA</option></select></div>
            <div className="campo-os"><label>TÉCNICO RESPONSÁVEL</label><select><option>Carlos Eduardo Souza</option></select></div>
            <div className="campo-os"><label>DATA DE INÍCIO</label><input type="date" /></div>
            <div className="campo-os"><label>PRAZO DE ENTREGA</label><input type="date" /></div>
            <div className="campo-os full"><label>OBSERVAÇÕES</label><textarea placeholder="Detalhes específicos do serviço..."></textarea></div>
          </div>
