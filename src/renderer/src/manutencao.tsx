...
import './asset/css/manutencao.css';
...
export default function Manutencao () {
  ...
  return (
    <div className="manutencao-container">
      ...
      {abaAtiva === 'etapas' ? (
        <>
          <div className="grid-etapas-mt"> {/* CARDS DE ETAPAS (Fluxo Visual) */}
            <CardEtapa num="01" titulo="Diagnóstico" desc="Identificação de problemas e peças" ativa />
            <CardEtapa num="02" titulo="Orçamento Aprovado" desc="Envio e aprovação pelo cliente" />
            <CardEtapa num="03" titulo="Execução do Serviço" desc="Correções e substituição de peças" destaque />
            <CardEtapa num="04" titulo="Controle de Qualidade" desc="Inspeção final e testes" />
            <CardEtapa num="05" titulo="Entrega ao Cliente" desc="Assinatura do termo e entrega" />
          </div>
          <div className="tabela-mt-box"> {/* TABELA DE ORDENS DE SERVIÇO */}
            <table className="tabela-mt">
              ...
              <tbody>
                <tr>
                  <td><strong>#MT-041</strong></td>
                  <td>Honda HR-V · DEF-4G56</td>
                  <td>Preventiva</td>
                  <td><span className="tag-etapa v-03">03 — Execução</span></td>
                  <td>Marcos Rocha</td>
                  <td>20/05/2026</td>
                  <td><span className="badge-status andamento">Em Andamento</span></td>
                </tr>
                <tr>
                  <td><strong>#MT-042</strong></td>
                  <td>VW T-Cross · GHI-7J89</td>
                  <td>Corretiva</td>
                  <td><span className="tag-etapa v-01">01 — Diagnóstico</span></td>
                  <td>Marcos Rocha</td>
                  <td>25/05/2026</td>
                  <td><span className="badge-status aguardando">Aguardando</span></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="form-mt-card"> /* FORMULÁRIO DE NOVA OS */
          ...
          <div className="form-mt-grid">
            ...
            <div className="campo-mt">
              <label>VEÍCULO</label>
              <select><option>Selecionar veículo...</option></select>
            </div>
            <div className="campo-mt">
              <label>TIPO DE MANUTENÇÃO</label>
              <select><option>Preventiva</option><option>Corretiva</option></select>
            </div>
            <div className="campo-mt double">
              <label>MECÂNICO RESPONSÁVEL</label>
              <select><option>Marcos Antônio Rocha</option></select>
            </div>
            <div className="campo-mt">
          ...
          <div className="form-mt-acoes">
            <button className="btn-cancelar" onClick={() => setAbaAtiva('etapas')}>Cancelar</button>
