...
export default function Documentos () {
  ...
  const listaDocs = [
    { id: 1, nome: "Certificado de Blindagem #BL-001", tipo: "Certificado", veiculo: "ABC-1D23", cliente: "João P. Almeida", data: "15/05/2026" },
    { id: 2, nome: "Laudo de Manutenção #MT-041", tipo: "Laudo", veiculo: "DEF-4G56", cliente: "Trans. Veloz", data: "18/05/2026" },
    { id: 3, nome: "Termo de Entrega — João Almeida", tipo: "Termo", veiculo: "ABC-1D23", cliente: "João P. Almeida", data: "12/04/2026" },
  ];
            ...
            {listaDocs.map((doc) => (
              <tr key={doc.id}>
                ...
                <td className="doc-acoes-celula">
                  <button className="btn-doc-acao" title="Visualizar">👁️</button>
                  <button className="btn-doc-acao" title="Download">📥</button>
                </td>
              </tr>
            ))}
          </tbody>
